...
@section('content')
    <div class="panel panel-default">
        <div class="panel-heading">
            ...
            <span class="panel-tit">编辑清关</span>
        </div>
        ...
        <div class="panel-body navbar-form" style="padding-top: 20px;">
            <form id="editForm">
                ...
                <!-- 清关名称 -->
                <div class="form-item">
                    <label class="label">清关名称：</label>
                    <div class="field">
                        <input type="text" name="name" value="{{ $clearance->name ?? '' }}"
                               placeholder="请输入清关名称" class="form-control input-sm w50" required>
                    </div>
                </div>
                ...
                <div class="form-item">
                    ...
                    <div class="field">
                        <input type="text" name="name_kr" value="{{ $clearance->name_kr ?? '' }}"
                ...
                <div class="form-item">
                    ...
                    <div class="field">
                        <input type="number" name="sort" value="{{ $clearance->sort ?? 0 }}"
                ...
                <div class="form-item">
                    ...
                    <div class="field">
                        <label style="margin-right: 20px;">
                            <input type="radio" name="status" value="1" {{ $clearance->status == 1 ? 'checked' : '' }}> 启用
                        </label>
                        <label>
                            <input type="radio" name="status" value="0" {{ $clearance->status == 0 ? 'checked' : '' }}> 禁用
                        </label>
                    </div>
                </div>
                ...
                <div class="form-item">
                    ...
                    <div class="field">
                        ...
                        <a href="{{ route('admin.clearances.index') }}" class="btn btn-warning btn-sm" style="margin-left:10px;">
    ...
    <script type="text/javascript">
        $(function(){
            $("#submitBtn").click(function(){
                ...
                $.ajax({
                    url: "{{ route('admin.clearances.update', $clearance->id) }}",
                    type: "POST",
                    data: formData,
                    dataType: "json",
                    success: function(data){
                        alert(data.msg);
                        if (data.code === 200) {
                            window.location.href = "{{ route('admin.clearances.index') }}";
                        }
                    },
                    error: function(xhr){
