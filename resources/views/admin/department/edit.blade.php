...
@section('content')
    <div class="panel panel-default">
        <div class="panel-heading">
            ...
            <span class="panel-tit">编辑部门</span>
        </div>
        ...
        <div class="panel-body navbar-form" style="padding-top: 20px;">
            <form id="editForm">
                ...
                <div class="form-item">
                    ...
                    <div class="field">
                        <input type="text" name="name" value="{{ $department->name }}" placeholder="请输入部门名称"
                ...
                <div class="form-item">
                    ...
                    <div class="field">
                        <label style="margin-right: 20px;">
                            <input type="radio" name="status" value="1" {{ $department->status == 1 ? 'checked' : '' }}> 启用
                        </label>
                        <label>
                            <input type="radio" name="status" value="0" {{ $department->status == 0 ? 'checked' : '' }}> 禁用
                        </label>
                    </div>
                </div>
                ...
                <div class="form-item">
                    ...
                    <div class="field">
                        ...
                        <a href="{{ route('admin.departments.index') }}" class="btn btn-warning btn-sm" style="margin-left:10px;">
    ...
    <script type="text/javascript">
        $(function(){
            $("#submitBtn").click(function(){
                ...
                $.ajax({
                    url: "{{ route('admin.departments.update', $department->id) }}",
                    type: "POST",
                    data: formData,
                    dataType: "json",
