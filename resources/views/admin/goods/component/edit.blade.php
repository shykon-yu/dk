...
@section('content')
    <div class="panel panel-default">
        <div class="panel-heading">
            ...
            <span class="panel-tit">编辑材质成分</span>
        </div>
        ...
        <div class="panel-body navbar-form" style="padding-top: 20px;">
            <form id="editForm">
                ...
                <div class="form-item">
                    ...
                    <div class="field">
                        <input type="text" name="name" value="{{ $component->name }}" placeholder="请输入中文名称"
                ...
                <div class="form-item">
                    ...
                    <div class="field">
                        <input type="text" name="name_kr" value="{{ $component->name_kr }}" placeholder="한글이름 입력"
                               class="form-control input-sm w50" required>
                    </div>
                </div>
                ...
                <div class="form-item">
                    ...
                    <div class="field">
                        <input type="text" name="name_en" value="{{ $component->name_en }}" placeholder="English name"
                               class="form-control input-sm w50" required>
                    </div>
                </div>
                ...
                <div class="form-item">
                    ...
                    <div class="field">
                        <input type="number" name="sort" value="{{ $component->sort }}" placeholder="数字越小越靠前"
                               class="form-control input-sm w50" required>
                    </div>
                </div>
                ...
                <div class="form-item">
                    ...
                    <div class="field">
                        <label style="margin-right: 20px;">
                            <input type="radio" name="status" value="1" {{ $component->status == 1 ? 'checked' : '' }}> 启用
                        </label>
                        <label>
                            <input type="radio" name="status" value="0" {{ $component->status == 0 ? 'checked' : '' }}> 禁用
                        </label>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        $(function(){
            $("#submitBtn").click(function(){
                ...
                $.post("{{ route('admin.goods.components.update', $component->id) }}", formData, function(data){
                    alert(data.msg);
                    if (data.code === 200) {
