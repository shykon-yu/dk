...
@section('content')
    <div class="panel panel-default">
        <div class="panel-heading">
            ...
            <span class="panel-tit">编辑入库</span>
        </div>
                        ...
                        <tr>
                            ...
                            <td data-key="quantity" class="padding_0">
                                <input type="text" class="form-control input_no_border input-sm quantity"
                                       name="quantity" value="{{ $item->quantity }}" placeholder="入库数量">
                            </td>
    ...
    <div class="form-group container">
        ...
        <textarea class="form-control" rows="5" id="comment">{{ $inbound->comment }}</textarea>
    </div>
        ...
        $(function () {
            ...
            $("#orderCodeConfirm").click(function () {
                ...
                $checked.each(function () {
                    const $pTr     = $(this).closest("tr");
                    const $active  = $(".active:last");
                    const rowClone = $active.clone();
                    ...
                    const remainNumber   = totalNumber - inQuantity;
            ...
            $("#order").validate({
                ...
                submitHandler: function (form) {
                    ...
                    formData.append('_method', 'PUT'); // 编辑关键
                    ...
                    $.ajax({
                        url: "{{ route('admin.inbounds.update', $inbound->id) }}",
                        type: "POST",
                        data: formData,
                        contentType: false,
                        processData: false,
