...
@section('content')
    <div class="panel panel-default">
        <div class="panel-heading">
            ...
            <span class="panel-tit">新增用户</span>
        </div>
        ...
        <div class="panel-body navbar-form" style="padding-top: 20px;">
            <form id="createUserForm">
                ...
                <div class="form-item">
                    ...
                    <div class="field">
                        <input type="text" name="phone_number" value="" placeholder="请输入手机号"
                               class="form-control input-sm w50">
                    </div>
                </div>
                ...
                <div class="form-item">
                    ...
                    <div class="field">
                        <input type="text" name="open_id" value="" placeholder="第三方OpenID（选填）"
                               class="form-control input-sm w50">
                    </div>
                </div>
    ...
    <script type="text/javascript">
        $(function(){
            ...
            $("#submitBtn").click(function(){
                ...
                $.post("{{ route('admin.users.store') }}", formData, function(data){
                    alert(data.msg);
                    if (data.code === 200) {
