...
@section('content')
    <div class="panel panel-default">
        <div class="panel-heading">
            ...
            <span class="panel-tit">编辑仓库</span>
        </div>
        ...
        <div class="panel-body navbar-form" style="padding-top: 20px;">
            <form id="createForm">
                ...
                <div class="form-item">
                    ...
                    <div class="field">
                        <select name="department_id" class="form-control input-sm" title="请选择部门" required>
                            <option>--请选择部门--</option>
                            @foreach($_departments as $dept)
                                <option value="{{ $dept->id }}"
                                    {{ $warehouse->department_id == $dept->id ? 'selected' : '' }}>
                                    {{ $dept->name }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="form-item">
                    ...
                    <div class="field">
                        <input type="text" name="name" value="{{ $warehouse->name }}"
                               placeholder="请输入仓库名称" class="form-control input-sm w50" required>
                    </div>
                </div>
                ...
                <div class="form-item">
                    ...
                    <div class="field">
                        <input type="number" name="sort" value="{{ $warehouse->sort }}"
                ...
                <div class="form-item">
                    ...
                    <div class="field">
                        <label style="margin-right: 20px;">
                            <input type="radio" name="status" value="1" {{ $warehouse->status == 1 ? 'checked' : '' }}> 启用
                        </label>
                        <label>
                            <input type="radio" name="status" value="0" {{ $warehouse->status == 0 ? 'checked' : '' }}> 禁用
                        </label>
                    </div>
                </div>
                ...
                <div class="form-item">
                    ...
                    <div class="field">
                        ...
                        <a href="{{ route('admin.warehouses.index') }}" class="btn btn-warning btn-sm" style="margin-left:10px;">
